...
let tipoVehiculoAgregarOReemplazar: string = readlineSync.question('Ingrese el tipo de vehiculo que desea agregar o reemplazar (auto, moto o camion) o presione "ENTER" para ir a la proxima Seccion: \n');

while (tipoVehiculoAgregarOReemplazar != '') {
    try {
        let tipoEnMinus = tipoVehiculoAgregarOReemplazar.toLocaleLowerCase();
        if (tipoEnMinus != 'auto' && tipoEnMinus != 'moto' && tipoEnMinus != 'camion') {
            throw new Error('No ha ingresado un tipo de vehículo válido');
        }
        switch (tipoEnMinus) {
            case 'auto':
                let arregloDatosAuto: any[] = new Array(7);
                ...
                let auto: Auto = new Auto(parseInt(arregloDatosAuto[0]), arregloDatosAuto[1], arregloDatosAuto[2], parseInt(arregloDatosAuto[3]), arregloDatosAuto[4], arregloDatosAuto[5], parseInt(arregloDatosAuto[6]));

                let eleccionAuto: number = readlineSync.question('Presione 1 para agregarlo al listado o presione 2 para reemplazarlo por otro: \n');
                ...
                if (eleccionAuto == 1) {
                    ...
                    let posicionAuto: number = readlineSync.question('En qué posicion de la lista se encuentra el auto que desea reemplazar?: \n');
            ...
            case 'moto':
                ...
                let moto: Moto = new Moto(parseInt(arregloDatosMoto[0]), arregloDatosMoto[1], arregloDatosMoto[2], parseInt(arregloDatosMoto[3]), arregloDatosMoto[4], arregloDatosMoto[5], parseInt(arregloDatosMoto[6]));

                let eleccionMoto: number = readlineSync.question('Presione 1 para agregarlo al listado o presione 2 para reemplazarlo por otro: \n');
                ...
                if (eleccionMoto == 1) {
                    ...
                    let posicionMoto: number = readlineSync.question('En qué posicion de la lista se encuentra la moto que desea reemplazar?: \n');
            ...
            case 'camion':
                ...
                let arregloDatosCamion: any[] = new Array(7);
                ...
                let camion: Camion = new Camion(parseInt(arregloDatosCamion[0]), arregloDatosCamion[1], arregloDatosCamion[2], parseInt(arregloDatosCamion[3]), arregloDatosCamion[4], arregloDatosCamion[5], parseInt(arregloDatosCamion[6]));

                let eleccionCamion: number = readlineSync.question('Presione 1 para agregarlo al listado, presione 2 para reemplazarlo por otro: \n');
                ...
                if (eleccionCamion == 1) {
                    ...
                    let posicionCamion: number = readlineSync.question('En qué posicion de la lista se encuentra el camion que desea reemplazar?: \n');
...
while (vehiculoBuscado != '') {
    try {
        ...
        switch (vehiculoBuscado) {
            case '1':
                let numeroListaBuscado: number = readlineSync.question('Ingrese el numero en la lista del vehiculo buscado: \n');
                ...
                let eleccionUsuario1: number = readlineSync.question('Presione 1 para mostrarlo en pantalla o presiones 2 para eliminarlo: \n');
            ...
            case '2':
                ...
                let eleccionUsuario2: number = readlineSync.question('Presione 1 para mostrarlo en pantalla o presione 2 para eliminarlo: \n')
